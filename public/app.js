...
function toggleRentals(on){document.getElementById('edp-schedule')?.querySelectorAll('.gbar').forEach(b=>{b.style.opacity=on&&b.closest('.g2-row')?.querySelector('.chip.ok')?'1':(on?'.4':'1');});}
