...
const EQLINES=[
 {nm:'Excavator 45–55T',qty:2,cat:'Earthmoving',phase:'Sitework & Civil',code:'31210000.3005.2000',start:0,span:6,cost:'$101K',cls:''},
 {nm:'Wheel loader 3yd',qty:1,cat:'Earthmoving',phase:'Sitework & Civil',code:'31220000.3005.2000',start:0,span:4,cost:'$24K',cls:''},
 {nm:'Water truck 4K',qty:1,cat:'Support',phase:'Sitework & Civil',code:'31230000.3005.2000',start:0,span:6,cost:'$31K',cls:''},
 {nm:'Tower crane',qty:1,cat:'Lifting',phase:'Structure',code:'05100000.3005.2000',start:2,span:3,cost:'$318K',cls:'n2'},
 {nm:'Telehandler 10K',qty:2,cat:'Lifting',phase:'Structure',code:'05120000.3005.2000',start:2,span:5,cost:'$86K',cls:'n2'},
 {nm:'Scissor lift 32ft',qty:4,cat:'Aerial',phase:'MEP / Electrical',code:'26260000.3005.2000',start:4,span:4,cost:'$37K',cls:'n3'},
 {nm:'Boom lift 60ft',qty:2,cat:'Aerial',phase:'MEP / Electrical',code:'26261000.3005.2000',start:5,span:3,cost:'$52K',cls:'n3'}
];
...
function buildDemandRollup(){
  ...
  return `<div style="display:flex;flex-direction:column;gap:18px">
    ${data.map(d=>`<div style="display:flex;align-items:flex-end;gap:14px">
      ...
      <div style="text-align:right;flex-shrink:0;padding-bottom:20px;min-width:72px">${(()=>{const maxSingle=Math.max(...d.lines.map(l=>l.qty));const flag=d.peak>maxSingle;return `<div style="font-size:20px;font-weight:700;line-height:1;color:${d.peak>1?'var(--charcoal)':'var(--gray-400)'}">${d.peak}</div><div style="font-size:10px;color:var(--gray-500)">peak · ${MONTHS[d.peakMonth]}</div>${flag?`<div style="font-size:9px;color:var(--gold-mid);margin-top:3px;font-weight:600">${ic('warning','ic-12')} ${d.lines.length} lines overlap</div>`:''}`;})()} </div>
    </div>`).join('')}
